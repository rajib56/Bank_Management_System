...
public class Withdraw extends JFrame
{
  ...
  Withdraw()
   ...
   f.setContentPane(new JLabel (new ImageIcon("Withdraw_Back.jpg")));
   l1=new JLabel("Date :");  
   ...
   b2.setBounds(230,340,150,30);
   b2.setContentAreaFilled(false);
   b2.setOpaque(false);
   b2.setBorderPainted(true);
   String s1[]={"Cash","Cheque","Debit Card"};
   ...
   b1.addActionListener((ActionEvent event) -> {
	...
	b2.addActionListener((ActionEvent event) -> {
			JOptionPane.showMessageDialog(f,"Money has been Withdrawn!!!","Withdraw",JOptionPane.PLAIN_MESSAGE);
			});
